...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
  <tr>
    <td align="left" valign="top" width="100%" style="background-color:white;">
      <center>
      <!-- <img src="http://s3.amazonaws.com/swu-filepicker/SBb2fQPrQ5ezxmqUTgCr_transparent.png" class="force-width-gmail"> -->
        <table cellspacing="0" cellpadding="0" width="100%" style="background-color:transparent">
          <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href="https://srworld.sk"><img width="165" height="47" src="https://gallery.srworld.sk/logo_new.png" alt="logo"></a>
                    </td>
                    <td class="pull-right mobile-header-padding-right" style="color: #4d4d4d;">
                      <a href="https://www.instagram.com/srworld_sro/"><img width="44" height="47" src="https://gallery.srworld.sk/insta.png" alt="instagram" /></a>
                      <a href="https://www.facebook.com/srworldsro/"><img width="38" height="47" src="https://gallery.srworld.sk/fb.png" alt="facebook" /></a>
                    </td>
                  </tr>
                </table>
              </center>
  ...
  <tr>
    <td align="center" valign="top" width="100%" style="background-color: #e7e9f0;" class="content-padding">
      <center>
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                              <td style='text-align:left'>
                                {{ $contact_form->getName() }} [{{ $contact_form->getEmail() }}]
                              </td>
                            </tr>
                            <tr>
                              <td class="user-msg">
                                "{{ $contact_form->getMessage() }}"
                              </td>
                            </tr>
                          </table>
                        </td>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>SR WORLD s.r.o.</strong><br />
              Jašíkova 3151/15 <br />
              821 03 Bratislava <br /><br />
            </td>
          </tr>
        </table>
      </center>
